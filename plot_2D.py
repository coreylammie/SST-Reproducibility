...
if fit_raw_data:
    plt.plot(np.linspace(150, 500), lrs_model.model_tempurature_dependence(np.linspace(150, 500), **lrs_parameters), linestyle='--', color='b', marker='o', markersize=15, markerfacecolor='None', markeredgewidth=1)
    plt.plot(np.linspace(150, 500), hrs_model.model_tempurature_dependence(np.linspace(150, 500), **hrs_parameters), linestyle='--', color='r', marker='o', markersize=15, markerfacecolor='None', markeredgewidth=1)
