...
plt.scatter(np.linspace(150, 500), lrs_model.model_tempurature_dependance(np.linspace(150, 500), **lrs_parameters), label='LRS Model', color='b', marker='s')
plt.scatter(np.linspace(150, 500), hrs_model.model_tempurature_dependance(np.linspace(150, 500), **hrs_parameters), label='HRS Model', color='r', marker='s')
plt.yscale('log')
